...
export const packages = [
  ...
  {
    id: "02",
    name: "بكج الزفة + كواليس",
    price: "1200",
    duration: "ساعتان",
    summary: "تصوير الزفة + كواليس جلسة تصوير الفوتو + مونتاج احترافي بأحدث المعدات.",
    bestFor: "عروس تريد توثيق الزفة مع كواليس جلسة الصور بدون تغطية يوم كامل.",
    deliverable: "فيلم زفة + كواليس فوتو",
    sequence: ["كواليس جلسة الفوتو", "تجهيز الإضاءة", "تصوير الزفة", "مونتاج احترافي"],
    bullets: [
      "يبدأ تصوير الكواليس مع بداية جلسة تصوير الفوتو",
      "تصوير سينمائي بأحدث المعدات"
    ]
  },
  {
    id: "03",
    ...
    price: "1700",
    duration: "3 ساعات",
    summary: "First Look + تفاصيل العروس (المجوهرات، المسكة، الكعب، العطر) + تفاصيل الكوشة + كواليس جلسة الفوتو + زفة واحدة + مونتاج احترافي.",
    bestFor: "العروس التي تريد قصة أنيقة لا تكتفي بلقطة الدخول.",
    deliverable: "فيلم نصف اليوم",
    sequence: ["First Look", "تفاصيل العروس", "تفاصيل الكوشة", "كواليس الفوتو", "الزفة"],
    bullets: [
      "تفاصيل المجوهرات والمسكة والكعب والعطر",
      "First Look ولحظات مشاعر عفوية"
    ],
  ...
  },
  {
    ...
    price: "2500",
    duration: "6 ساعات",
    summary: "تصوير العروس في الصالون (تفاصيل المكياج، الشعر) + First Look + تفاصيل العروس + تفاصيل الكوشة + تفاصيل القاعة + كواليس جلسة الفوتو + زفتين + مونتاج احترافي.",
    bestFor: "العروس التي تريد قصة اليوم كاملة من الصالون إلى القاعة.",
    deliverable: "فيلم يوم كامل",
    sequence: ["الصالون", "First Look", "القاعة والكوشة", "كواليس الفوتو", "زفتين"],
    bullets: [
      "تفاصيل المكياج والشعر في الصالون",
      "تفاصيل القاعة والكوشة والزفتين"
    ],
    featured: true,
  ...
  },
  {
    ...
    summary: "تفاصيل العروس + الكوشة + الشبكة + التلبيس + الكيك + الزفة + مونتاج احترافي.",
    bestFor: "خطوبة أو ملكة تحتاج حفظ التفاصيل واللحظات العائلية بنعومة.",
    deliverable: "فيلم خطوبة",
    sequence: ["تفاصيل العروس", "الشبكة", "التلبيس والكيك", "الزفة"],
    bullets: [
      "مصمم خصيصا للخطوبة والملكة",
      "تغطية لحظات التلبيس والشبكة بأسلوب راقي"
    ]
  }
];

// PDF source-of-truth additions Codex missed:
...
export const packageAddOns = [
  ...
  {
    id: "color-grade",
    name: "التلوين السينمائي + تنعيم البشرة",
  ...
  },
  {
    ...
    price: "مشمولة في بكج 01",
    description: "إضاءة محترفة تسلط على العروس وقت الزفة لإبراز اللحظة في الإضاءة المعتمة."
  }
];

export const paymentTerms = [
  { step: "1", text: "يتم إرسال رقم البكج المختار." },
  { step: "2", text: "يتم تأكيد الحجز عن طريق تحويل عربون بنصف قيمة الفاتورة (العربون لا يُرد عند الغاء الحجز)." },
  { step: "3", text: "يتم الحجز عن طريق التحويل لأحد حساباتنا البنكية وإرسال الإيصال." },
  { step: "4", text: "مدة الحجز يومين فقط، وفي حالة عدم تحويل العربون يعتبر الحجز ملغي." },
  { step: "5", text: "الساعة الإضافية بسعر 200 ريال." },
  { step: "6", text: "يتم تسليم المبلغ المتبقي في يوم المناسبة قبل بداية التصوير." }
];
...
export const credentials = {
  ...
  womenOnlyAr: "نسائي 100% — لا يحضر رجال",
  womenOnlyEn: "100% women-only set — no male crew on site",
  whatsappOfficialLink: "https://wa.me/message/RUHGT5HZCULJF1",
  equipmentAr: "أحدث المعدات السينمائية"
};
