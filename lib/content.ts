...
export const whatsappLink = (source = "website") =>
  `https://wa.me/${whatsappNumber}?text=${encodeURIComponent(
    `السلام عليكم، وصلتكم من ${readableWhatsappSource(source)} في Asmaa Video وأرغب بمعرفة التوفر واختيار الباقة المناسبة.`
  )}`;
...
export const serviceAreas: ServiceArea[] = [
  {
    ...
    metaTitle: "مصورة زواجات في الأحساء | Asmaa Video",
    metaDescription:
  ...
  },
  {
    ...
    metaTitle: "مصورة زواجات في الدمام | Asmaa Video",
    metaDescription:
    ...
    faq: [
      {
        ...
        answer:
          "تبدأ باقات تصوير الفيديو من 600 ريال لبكج الزفة وتصل إلى 2500 ريال لتغطية اليوم الكامل، والأسعار نفسها معلنة في صفحة الباقات بدون رسوم تنقل"
      },
      {
        question: "ما هي قاعات الأفراح في الدمام التي لديكم خبرة في التصوير فيها؟",
        answer:
          "نغطي قاعات الأفراح والفنادق في الدمام، ونرتّب تفاصيل القاعة والإضاءة ووقت الوصول قبل المناسبة عبر واتساب حتى تكون التغطية مرتبة من أول لحظة"
      },
      {
  ...
  },
  {
    ...
    metaTitle: "مصورة زواجات في الخبر | Asmaa Video",
    metaDescription:
    ...
    faq: [
      {
        ...
        answer:
          "تبدأ باقات تصوير الفيديو من 600 ريال لبكج الزفة وتصل إلى 2500 ريال لباقة اليوم الكامل من الصالون إلى القاعة، والسعر المعلن في صفحة الباقات هو السعر النهائي"
      },
      {
        question: "هل تغطون حفلات في فنادق وقاعات الخبر؟",
        answer:
          "نعم، نغطي حفلات الزفاف والخطوبة في قاعات وفنادق الخبر، وننسّق تفاصيل القاعة والإضاءة قبل المناسبة حتى تظهر الزفة بأفضل شكل"
      },
      {
        question: "كم مدة تسليم فيديو الزفاف في الخبر؟",
        answer:
          "مدة المونتاج والتسليم تتراوح بين أسبوعين إلى أربعة أسابيع بحسب الباقة والموسم، ويتم إبلاغك بالمدة الدقيقة عند تأكيد الحجز"
      },
      {
        question: "هل تتوفر جلسات تصوير خارجية في الخبر؟",
        answer:
          "باقاتنا الأساسية تغطي حفلات الزفاف والخطوبة داخل القاعات والفنادق، وإذا كانت مناسبتك تتضمن فقرة خارجية راسلينا عبر واتساب لنرتّبها ضمن الباقة"
      }
    ]
  },
  {
    ...
    metaTitle: "مصورة زواجات في الهفوف | Asmaa Video",
    metaDescription:
  ...
  },
  {
    ...
    metaTitle: "مصورة زواجات في المبرز | Asmaa Video",
    metaDescription:
    ...
    faq: [
      ...
      },
      {
        ...
        answer:
          "إذا كانت التفاصيل قليلة فبكج الزفة والكواليس يكفي؛ للتفاصيل واللقطات الأوسع، Half Day أو Full Day الأنسب."
      }
    ]
  },
  {
    ...
    metaTitle: "مصورة زواجات في العمران | Asmaa Video",
    metaDescription:
  ...
  },
  {
    ...
    metaTitle: "مصورة زواجات في الطرفية | Asmaa Video",
    metaDescription:
  ...
  },
  {
    ...
    metaTitle: "مصورة زواجات في القطيف | Asmaa Video",
    metaDescription:
  ...
  },
  {
    ...
    metaTitle: "مصورة زواجات في الجبيل | Asmaa Video",
    metaDescription:
    ...
    faq: [
      ...
      },
      {
        ...
        answer:
          "للتغطية الكاملة Full Day هو الأنسب؛ ولمن تريد الزفة وتفاصيل الكوشة فقط فبكج الزفة والكواليس يفي بالغرض."
      }
    ]
  }  ,
  {
    ...
    ar: "حفر الباطن",
    en: "Hafr Al-Batin",
    priority: "تغطية حفر الباطن",
    headline: "تصوير زواج وخطوبة في حفر الباطن بأسلوب يناسب ذوق المنطقة",
    metaTitle: "مصورة زواجات في حفر الباطن | Asmaa Video",
    metaDescription: "تصوير فيديو زواج وخطوبة نسائي في حفر الباطن. باقات واضحة، تفاصيل عروس، زفة مصورة، وحجز عبر واتساب.",
    heroLine: "لعروس حفر الباطن التي تبحث عن مصورة نسائية تحفظ تفاصيل اليوم بأسلوب أنيق ومرتب.",
    searchIntent: "عميلة في حفر الباطن تبحث عن مصورة نسائية ذات باقات واضحة قبل التواصل.",
    audience: "عروس أو عميلة من سكان حفر الباطن تريد معرفة الباقة والسعر والتوفر قبل أول رسالة.",
    localPromise: "تغطية لقاعات حفر الباطن مع رابط حجز يختصر الاختيار ويجمع تفاصيل اليوم.",
    cityProof: "محتوى يناسب حفر الباطن: نبرة هادئة، باقات واضحة، ولقطات بأسلوب محافظ يليق بالمناسبة.",
    neighborhoodSignals: ["حي الخليج", "حي النهضة", "حي الملك فهد", "حي السلام", "حي الربيع", "حي الورود"],
    keywordCluster: [
      "مصورة زواجات حفر الباطن",
      "تصوير فيديو زواج حفر الباطن",
      "مصورة عرايس حفر الباطن",
      "تصوير خطوبة حفر الباطن",
      "باقات تصوير حفر الباطن"
    ],
    contentWave: [
      "تحديد القاعة في حفر الباطن لتقدير وقت الوصول.",
      "اختيار الباقة حسب اللحظات المطلوبة.",
      "إرسال التاريخ من رابط العروس.",
      "تأكيد التوفر عبر واتساب."
    ],
    faq: [
      {
        question: "هل تصلون قاعات حفر الباطن؟",
        answer: "نعم، الخدمة تغطي حفر الباطن مع ترتيب مسبق للوصول حسب موقع القاعة."
      },
      {
        question: "كيف أحجز تصوير في حفر الباطن؟",
        answer: "أرسلي التاريخ والمدينة والباقة عبر رابط العروس أو واتساب، وسيصل تأكيد التوفر خلال ساعات."
      }
    ]
  },
  {
    ...
    ar: "أبقيق",
    en: "Abqaiq",
    priority: "تغطية أبقيق",
    headline: "تصوير زواج وخطوبة في أبقيق بلقطات هادئة وتفاصيل لا تنسى",
    metaTitle: "مصورة زواجات في أبقيق | Asmaa Video",
    metaDescription: "تصوير فيديو زواج وخطوبة نسائي في أبقيق. باقات مناسبة للمناسبات الأسرية والزفة المصورة.",
    heroLine: "لعروس أبقيق التي تريد فيلما أنيقا يحفظ زفتها وتفاصيل يومها بأسلوب هادئ.",
    searchIntent: "عميلة في أبقيق تبحث عن مصورة زواج نسائية بباقات واضحة.",
    audience: "عروس أو عميلة من سكان أبقيق تريد وضوح الباقة والسعر والتوفر.",
    localPromise: "تغطية أنيقة في أبقيق مع رابط حجز يجمع التفاصيل ويختصر المحادثة.",
    cityProof: "نبرة مرتبة تناسب أبقيق: باقات مفهومة، ولقطات بأسلوب يحترم خصوصية المناسبة.",
    neighborhoodSignals: ["حي الغدير", "حي الروضة", "حي الأمل", "حي العزيزية", "وسط أبقيق"],
    keywordCluster: [
      "مصورة زواجات أبقيق",
      "تصوير فيديو زواج أبقيق",
      "مصورة عرايس أبقيق",
      "تصوير خطوبة أبقيق"
    ],
    contentWave: [
      "تحديد القاعة أو الحي في أبقيق.",
      "اختيار الباقة حسب اللحظات المهمة.",
      "إرسال التاريخ والتفاصيل عبر الرابط.",
      "تأكيد التوفر والخطوة التالية عبر واتساب."
    ],
    faq: [
      {
        question: "هل تغطون مناسبات في أبقيق؟",
        answer: "نعم، الخدمة تصل أبقيق مع ترتيب مسبق للتفاصيل."
      },
      {
        question: "ما الباقة المناسبة لمناسبة أسرية في أبقيق؟",
        answer: "بكج الزفة والكواليس مناسب للمناسبات الأسرية التي تركز على لحظة الدخول والتفاصيل الأساسية."
      }
    ]
  },
  {
    ...
    ar: "رأس تنورة",
    en: "Ras Tanura",
    priority: "تغطية رأس تنورة",
    headline: "تصوير زواج وخطوبة في رأس تنورة بأجواء ساحلية وتفاصيل مرتبة",
    metaTitle: "مصورة زواجات في رأس تنورة | Asmaa Video",
    metaDescription: "تصوير فيديو زواج وخطوبة نسائي في رأس تنورة. لقطات أنيقة، زفة مصورة، وباقات واضحة.",
    heroLine: "لعروس رأس تنورة التي تريد فيلما يحفظ تفاصيل يومها قرب الخليج.",
    searchIntent: "عميلة في رأس تنورة تبحث عن مصورة نسائية بأسلوب ساحلي أنيق.",
    audience: "عروس أو عميلة من سكان رأس تنورة تبحث عن مصورة بباقات مفهومة.",
    localPromise: "تغطية مميزة لمناسبات رأس تنورة مع لقطات تعكس أجواء المدينة.",
    cityProof: "نبرة أنيقة تناسب رأس تنورة: تفاصيل العروس، لقطات الكوشة، وزفة مرتبة.",
    neighborhoodSignals: ["حي النخيل", "حي الشاطئ", "حي الرصيف", "حي الخليج", "المجمع السكني أرامكو"],
    keywordCluster: [
      "مصورة زواجات رأس تنورة",
      "تصوير زواج رأس تنورة",
      "مصورة عرايس رأس تنورة",
      "تصوير خطوبة رأس تنورة"
    ],
    contentWave: [
      "تحديد القاعة أو الحي في رأس تنورة.",
      "اختيار الباقة حسب اللحظات المطلوبة.",
      "إرسال التفاصيل عبر رابط العروس.",
      "تأكيد التوفر عبر واتساب."
    ],
    faq: [
      {
        question: "هل تغطون قاعات رأس تنورة؟",
        answer: "نعم، الخدمة تصل رأس تنورة مع ترتيب مسبق للوصول حسب موقع القاعة."
      },
      {
        question: "ما الباقة الأنسب لمناسبات رأس تنورة؟",
        answer: "بكج الزفة والكواليس أو Full Day حسب عدد اللحظات المطلوبة."
      }
    ]
  },
  {
    ...
    en: "Safwa",
    priority: "تغطية صفوى",
    headline: "تصوير زواج وخطوبة في صفوى بأسلوب محافظ وتفاصيل مرتبة",
    metaTitle: "مصورة زواجات في صفوى | Asmaa Video",
    metaDescription: "تصوير فيديو زواج وخطوبة نسائي في صفوى. باقات واضحة، زفة مصورة، وحجز عبر واتساب.",
    heroLine: "لعروس صفوى التي تريد تغطية أنيقة لمناسبتها بأسلوب يحترم الذوق المحلي.",
    searchIntent: "عميلة في صفوى تبحث عن مصورة زواج نسائية قريبة بباقات واضحة.",
    audience: "عروس أو عميلة من سكان صفوى تريد مصورة نسائية بنبرة هادئة ومرتبة.",
    localPromise: "تغطية تلائم مناسبات صفوى بباقات مرنة وأسلوب يناسب الخصوصية.",
    cityProof: "نبرة مرتبة وهادئة تناسب صفوى مع تفاصيل العروس والزفة.",
    neighborhoodSignals: ["حي الزهور", "حي الربيع", "حي السلام", "وسط صفوى", "حي النهضة"],
    keywordCluster: [
      "مصورة زواجات صفوى",
      "تصوير زواج صفوى",
      "مصورة عرايس صفوى",
    ...
    contentWave: [
      "تحديد القاعة في صفوى.",
      "اختيار الباقة المناسبة.",
      "إرسال تفاصيل المناسبة عبر الرابط.",
      "تأكيد التوفر عبر واتساب."
    ],
    faq: [
      {
        question: "هل تغطون مناسبات في صفوى؟",
        answer: "نعم، الخدمة تصل صفوى مع ترتيب مسبق للوصول."
      },
      {
        question: "ما الأسلوب المناسب لمناسبات صفوى؟",
        answer: "نبرة هادئة ومرتبة تحافظ على خصوصية المناسبة وتبرز تفاصيل العروس والزفة."
      }
    ]
  },
  {
    ...
    ar: "سيهات",
    en: "Saihat",
    priority: "تغطية سيهات",
    headline: "تصوير زواج وخطوبة في سيهات بلقطات أنيقة وتفاصيل دقيقة",
    metaTitle: "مصورة زواجات في سيهات | Asmaa Video",
    metaDescription: "تصوير فيديو زواج وخطوبة نسائي في سيهات. باقات واضحة، تفاصيل عروس، زفة مصورة.",
    heroLine: "لعروس سيهات التي تريد فيلما هادئا يحفظ لحظاتها الأجمل بتفاصيل أنيقة.",
    searchIntent: "عميلة في سيهات تبحث عن مصورة نسائية بأسلوب واضح وباقات مفهومة.",
    audience: "عروس أو عميلة من سكان سيهات تريد وضوح الباقة والسعر قبل التواصل.",
    localPromise: "تغطية مرتبة في سيهات مع لقطات تعكس تفاصيل العروس واليوم.",
    cityProof: "نبرة تناسب سيهات: تفاصيل دقيقة، أسلوب هادئ، وباقات مفهومة.",
    neighborhoodSignals: ["حي الربيع", "حي الفردوس", "وسط سيهات", "حي الحمراء", "حي النخيل"],
    keywordCluster: [
      "مصورة زواجات سيهات",
      "تصوير زواج سيهات",
      "مصورة عرايس سيهات",
    ...
    faq: [
      {
        question: "هل تغطون قاعات سيهات؟",
        answer: "نعم، الخدمة تصل سيهات مع ترتيب الوصول المسبق."
      },
      {
        question: "ما الباقة المناسبة لمناسبات سيهات؟",
        answer: "بكج الزفة والكواليس أو Full Day حسب عدد اللحظات المهمة."
      }
    ]
  },
  {
    ...
    ar: "تاروت",
    en: "Tarut",
    priority: "تغطية تاروت",
    headline: "تصوير زواج وخطوبة في تاروت بأسلوب تراثي حديث",
    metaTitle: "مصورة زواجات في تاروت | Asmaa Video",
    metaDescription: "تصوير فيديو زواج وخطوبة نسائي في تاروت. لقطات أنيقة تجمع بين الأصالة والحداثة.",
    heroLine: "لعروس تاروت التي تريد فيلما يحفظ تفاصيل مناسبتها بأسلوب يجمع الأصالة والحداثة.",
    searchIntent: "عميلة في تاروت تبحث عن مصورة زواج نسائية بأسلوب راقٍ ومرتب.",
    audience: "عروس أو عميلة من سكان تاروت تريد مصورة نسائية بباقات مفهومة.",
    localPromise: "تغطية مميزة في تاروت مع لقطات تعكس روح المناسبة وتفاصيل العروس.",
    cityProof: "نبرة تناسب تاروت: أسلوب هادئ، لقطات مرتبة، وتفاصيل تليق بالمناسبة.",
    neighborhoodSignals: ["حي القلعة", "حي الدانة", "وسط تاروت", "حي الفردوس", "حي الزهور"],
    keywordCluster: [
      "مصورة زواجات تاروت",
      "تصوير زواج تاروت",
      "مصورة عرايس تاروت",
    ...
    contentWave: [
      "تحديد القاعة في تاروت.",
      "اختيار الباقة المناسبة.",
      "إرسال التفاصيل عبر الرابط.",
      "تأكيد التوفر عبر واتساب."
    ],
    faq: [
      {
        question: "هل تغطون مناسبات في تاروت؟",
        answer: "نعم، الخدمة تصل تاروت مع ترتيب مسبق للوصول والتفاصيل."
      },
      {
        question: "ما الباقة الأنسب للمناسبات في تاروت؟",
        answer: "بكج الزفة والكواليس مناسب للمناسبات الأسرية؛ Full Day لمن تريد تغطية كاملة لليوم."
      }
    ]
  },
  {
    ...
    ar: "العديلية",
    en: "Udhailiyah",
    priority: "تغطية العديلية",
    headline: "تصوير زواج وخطوبة في العديلية بأسلوب راقٍ يناسب المجمعات السكنية",
    metaTitle: "مصورة زواجات في العديلية | Asmaa Video",
    metaDescription: "تصوير فيديو زواج وخطوبة نسائي في العديلية. باقات واضحة، تفاصيل عروس، وحجز عبر واتساب.",
    heroLine: "لعروس العديلية التي تريد فيلما احترافيا يحفظ لحظات مناسبتها بعيداً عن التعقيد.",
    searchIntent: "عميلة في العديلية تبحث عن مصورة نسائية ذات أسلوب راقٍ وباقات مفهومة.",
    audience: "عروس أو عميلة من سكان العديلية تريد وضوح الباقة والسعر والتوفر.",
    localPromise: "تغطية مرتبة في العديلية مع رابط حجز يختصر الاختيار.",
    cityProof: "نبرة راقية تناسب مجمعات العديلية: لقطات أنيقة وتفاصيل مميزة.",
    neighborhoodSignals: ["مجمع العديلية", "حي الروضة", "حي الخضراء", "المجمعات السكنية", "حي الفيصلية"],
    keywordCluster: [
      "مصورة زواجات العديلية",
      "تصوير زواج العديلية",
      "مصورة عرايس العديلية",
      "تصوير خطوبة العديلية"
    ],
    contentWave: [
      "تحديد القاعة أو المجمع في العديلية.",
      "اختيار الباقة حسب اللحظات المطلوبة.",
      "إرسال التفاصيل عبر رابط العروس.",
      "تأكيد التوفر عبر واتساب."
    ],
    faq: [
      {
        question: "هل تغطون مناسبات المجمعات في العديلية؟",
        answer: "نعم، الخدمة تصل المجمعات السكنية في العديلية مع ترتيب مسبق للوصول."
      },
      {
        question: "ما الأسلوب المناسب لمناسبات العديلية؟",
        answer: "أسلوب راقٍ وهادئ يناسب طبيعة المجمعات مع لقطات تبرز تفاصيل العروس والكوشة."
      }
    ]
  },
  {
    ...
    ar: "العوامية",
    en: "Awamiyah",
    priority: "تغطية العوامية",
    headline: "تصوير زواج وخطوبة في العوامية بلقطات تعكس روح المناسبة",
    metaTitle: "مصورة زواجات في العوامية | Asmaa Video",
    metaDescription: "تصوير فيديو زواج وخطوبة نسائي في العوامية. باقات واضحة، أسلوب هادئ، وحجز عبر واتساب.",
    heroLine: "لعروس العوامية التي تريد مصورة نسائية تحترم خصوصية المناسبة وتحفظ تفاصيلها.",
    searchIntent: "عميلة في العوامية تبحث عن مصورة زواج نسائية بباقات مرنة ومفهومة.",
    audience: "عروس أو عميلة من سكان العوامية تريد مصورة نسائية بنبرة هادئة.",
    localPromise: "تغطية محترمة في العوامية بأسلوب يناسب الذوق المحلي ويحفظ تفاصيل اليوم.",
    cityProof: "نبرة هادئة ومرتبة تناسب العوامية: خصوصية تامة وتفاصيل دقيقة.",
    neighborhoodSignals: ["وسط العوامية", "حي الروضة", "حي الإسكان", "حي الزهور", "حي النهضة"],
    keywordCluster: [
      "مصورة زواجات العوامية",
      "تصوير زواج العوامية",
      "مصورة عرايس العوامية",
      "تصوير خطوبة العوامية"
    ],
    contentWave: [
      "تحديد القاعة في العوامية.",
      "اختيار الباقة المناسبة.",
      "إرسال التفاصيل عبر الرابط.",
      "تأكيد التوفر عبر واتساب."
    ],
    faq: [
      {
        question: "هل تغطون مناسبات في العوامية؟",
        answer: "نعم، الخدمة تصل العوامية مع ترتيب مسبق للتفاصيل."
      },
      {
        question: "ما الباقة المناسبة لمناسبات العوامية؟",
        answer: "بكج الزفة أو الزفة والكواليس حسب اللحظات المطلوبة — كلاهما يحافظ على خصوصية المناسبة."
      }
    ]
  }
];
...
export const packages = [
  {
    ...
    price: "600",
    duration: "20 دقيقة",
    summary: "فيديو زفة فقط مع إضاءة المون لايت التي تسلَّط على العروس وقت الزفة، ومونتاج احترافي.",
    bestFor: "عروس تريد ذكرى واضحة للحظة الدخول بدون تغطية تفاصيل اليوم.",
    deliverable: "فيلم زفة سينمائي",
    sequence: ["الحضور قبل الزفة بربع ساعة", "تجهيز إضاءة المون لايت", "تصوير الزفة", "مونتاج احترافي"],
    bullets: [
      "يشمل إضاءة المون لايت (إضاءة تسلَّط على العروس وقت الزفة)",
      "مونتاج احترافي",
      "الحضور قبل الزفة بربع ساعة",
      "يمكنك حجز بكج الزفة عند حجزك إحدى بكجات الألبومات لدينا"
    ]
  },
  {
    id: "02",
    name: "فيديو زفة + كواليس",
    price: "1200",
    duration: "ساعتان",
    summary: "فيديو زفة مع كواليس جلسة تصوير الفوتو ومونتاج احترافي — يبدأ تصوير الكواليس مع بداية جلسة تصوير الفوتو.",
    bestFor: "عروس تريد الزفة مع لقطات كواليس جلسة الفوتو بدون تغطية يوم كامل.",
    deliverable: "فيلم زفة وكواليس",
    sequence: ["بداية جلسة تصوير الفوتو", "كواليس الجلسة", "الزفة", "مونتاج احترافي"],
    bullets: ["فيديو زفة كامل", "كواليس جلسة تصوير الفوتو", "مونتاج احترافي"]
  },
  {
    id: "03",
    name: "Half Day",
  ...
  },
  {
    ...
    price: "2500",
    duration: "6 ساعات",
    summary: "تغطية كاملة من الصالون إلى القاعة: تفاصيل الميك اب والشعر، الفيرست لوك، تفاصيل العروس والكوشة، كواليس الفوتو، والزفات.",
    bestFor: "العروس التي تريد قصة اليوم كاملة من البداية إلى النهاية.",
    deliverable: "فيلم يوم كامل",
    sequence: ["الصالون", "الفيرست لوك", "كواليس الفوتو", "الزفات"],
    bullets: ["تصوير العروس في الصالون: الميك اب والشعر", "الفيرست لوك وتفاصيل العروس والكوشة", "كواليس جلسة الفوتو والزفات بمونتاج احترافي"],
    featured: true,
...
export const portfolioScenes = [
  {
    ...
    packageHint: "بكج الزفة أو الزفة والكواليس",
  ...
  },
  {
    ...
    packageHint: "الزفة والكواليس أو Full Day",
...
export const channelActions = [
  ...
  { label: "Instagram", task: "تغيير الاسم الظاهر إلى Asmaa Video | أسماء فيديو وتثبيت 3 منشورات.", status: "واجهة الانطباع" },
...
export const boardLevers = [
  ...
  { title: "One brand language", detail: "Asmaa Video، نفس الرقم، نفس الرابط، ونفس الوعد في كل قناة." }
];
...
export const paymentTerms: { step: string; text: string }[] = [
  { step: "1", text: "يتم إرسال رقم البكج المختار عبر واتساب أو رابط العروس مع التاريخ والمدينة." },
