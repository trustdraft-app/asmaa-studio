...
export const seoServices: SeoService[] = [
  ...
  { slug: "zaffa-plus-tasweer", ar: "تصوير الزفة والكواليس", en: "Zaffa Plus Videography", packageId: "02", price: 1200, durationAr: "ساعتان", shortDescAr: "زفة كاملة مع كواليس جلسة تصوير الفوتو.", highlightAr: "يبدأ تصوير الكواليس مع بداية جلسة الفوتو" },
...
export const seoIntroBank: string[] = [
  "تختار العروس في {city} {service} عندما تريد ذكرى تليق بيومها — Asmaa Video تقدمها بأسلوب هادئ وسعر شفاف.",
  "إذا كنت تبحثين عن {service} في {city}، فالقرار يبدأ من فهم الباقة قبل السعر. Asmaa Video تشرح ماذا ستصور قبل أي حساب.",
  "في {city}، الفرق بين فيلم زفاف عادي وفيلم لا يُنسى هو الهدوء والتخطيط. Asmaa Video تقدم {service} بمقاربة منظمة من البداية إلى النهاية.",
  "خدمة {service} في {city} من Asmaa Video مبنية على ثلاث ركائز: فريق نسائي مرخص، أسلوب سينمائي، وسعر معلن مسبقاً.",
  "كل عروس في {city} تستحق فيلماً يعكس جمال يومها. Asmaa Video تقدم {service} بإحساس عالٍ وتفاصيل لا تفوّت لحظة.",
  "ابدئي رحلة {service} في {city} من رابط واحد: اختاري الباقة، حددي التاريخ، وتابعي على واتساب بدون حقول إلزامية.",
  "Asmaa Video أصبحت الخيار الأول لعروس {city} الباحثة عن {service} يحفظ ذوق المناسبة وتفاصيل العروس معاً.",
  "في موسم الزواجات بـ{city}، يكون حجز {service} مبكراً ضرورة. Asmaa Video تفتح التقويم قبل ستة أشهر من المناسبة.",
  "اختياركِ لـ{service} في {city} يحدد شكل الذكرى. Asmaa Video تقدم الباقة المناسبة لقاعتك ومدة مناسبتك بدقة.",
  "Asmaa Video تغطي {city} بنفس مستوى التغطية في الأحساء — لأن جودة الفيلم لا تتبع المدينة، بل تتبع الفريق."
];
...
export const seoModifierPhraseBank: Record<string, string[]> = {
  price: [
    ...
    "الشفافية أساس عمل Asmaa Video: السعر والمدة واللقطات تظهر قبل أول رسالة."
  ],
  package: [
  ...
  trust: [
    "Asmaa Video فريق نسائي بالكامل مرخص من وزارة الموارد البشرية والتنمية الاجتماعية.",
  ...
  year: [
    ...
    "تحديث ٢٠٢٦: باقة بكج الزفة والكواليس بـ١٢٠٠ ريال، Half Day بـ١٧٠٠ ريال.",
    "للموسم القادم في ٢٠٢٦، Asmaa Video أضافت إضاءة المون لايت ضمن بكج الزفة الأساسي."
  ],
  exclusivity: [
  ...
  quality: [
    ...
    "جودة الفيلم تأتي من ثلاثة عوامل: المعدات، الإضاءة، والمونتاج. Asmaa Video تستثمر في الثلاثة.",
  ...
  guarantee: [
    ...
    "Asmaa Video تقدم اتفاقاً مفصلاً يضمن الباقة، التاريخ، طريقة الدفع، ومدة التسليم."
  ],
  offer: [
...
export const seoBudgetTiers = [
  { slug: "under-2k", ar: "أقل من ٢٠٠٠ ريال", en: "Under 2,000 SAR", min: 0, max: 2000, note: "بكج الزفة وبكج الزفة والكواليس — مناسبة للميزانية المختصرة" },
