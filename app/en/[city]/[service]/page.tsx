...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  const title = `${service.en} in ${city.en}, Saudi Arabia | Asmaa Video`;
  ...
  return {
    ...
    openGraph: { title, description: desc, url: `https://asmaa.video/en/${city.slug}/${service.slug}`, siteName: "Asmaa Video", images: socialPreviewImages, type: "website", locale: "en" },
  ...
  return (
    <main className="page-shell" lang="en" dir="ltr">
      ...
      <section className="section city-hero-20x"><div className="section-inner city-hero-grid"><div>
        ...
        <p className="section-copy">Asmaa Video delivers {service.en.toLowerCase()} in {city.en} with a fully women-only crew, ministry-licensed. Prices start at {service.price} SAR. Neighbourhoods covered: {city.neighborhoodSignals.slice(0, 3).join(", ")}.</p>
      ...
      <section className="section"><div className="section-inner">
        ...
        <h2 className="section-title">Other Asmaa Video offerings</h2>
