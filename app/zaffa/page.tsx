...
export const metadata: Metadata = {
  title: "بكج الزفة",
  description:
    "صفحة Asmaa Studio لبكج الزفة في الأحساء والدمام والخبر: سعر واضح، مدة مختصرة، وما الذي يشمله تصوير لحظة الدخول قبل واتساب.",
  alternates: {
    canonical: "https://asmaa.video/zaffa"
  },
  openGraph: {
    title: "بكج الزفة | Asmaa Studio",
    description:
      "للعميلة التي تريد تصوير لحظة الدخول فقط: هذه الصفحة تشرح بكج الزفة، متى يكفي، ومتى يكون الزفة المطور أنسب.",
...
const decisionPoints = [
  ...
  {
    title: "متى تنتقلين إلى الزفة المطور؟",
...
const quickChecks = [
  ...
  "حددي هل تريدين الزفة فقط أو الزفة المطور.",
