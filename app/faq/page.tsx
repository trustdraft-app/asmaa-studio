...
const faqs = [
  ...
  },
  {
    ...
    a: "العروس في الدمام تحتاج فريقا نسائيا يحترم خصوصية المناسبة ويعلن أسعاره قبل أول رسالة. أسماء ستوديو يقدم تغطية الأفراح والخطوبات في الدمام والخبر والأحساء والقطيف بفريق نسائي بالكامل وباقات مكتوبة من ٦٠٠ إلى ٢٥٠٠ ريال مع أمثلة أعمال واضحة قبل الحجز."
  },
  {
    q: "كم تكلفة تصوير الزواج في الخبر؟",
    a: "تبدأ باقات تغطية الأفراح في أسماء ستوديو من ٦٠٠ ريال لبكج الزفة وتصل إلى ٢٥٠٠ ريال لباقة اليوم الكامل الشاملة. لا توجد رسوم تنقل داخل الخبر، والسعر المعلن في صفحة الباقات هو السعر النهائي."
  },
  {
    q: "هل توجد مصورة نسائية في الأحساء؟",
    a: "نعم، أسماء ستوديو يعمل من الأحساء بفريق نسائي بالكامل من التصوير إلى المونتاج والتسليم، ويغطي الأفراح والخطوبات والملكات والمناسبات النسائية مع ضمان الخصوصية التامة للعروس وضيوفها."
  },
  {
